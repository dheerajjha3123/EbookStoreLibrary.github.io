   ...
   <div class="row">
      <div class="col-md-6">
         <div class="row">
            <div class="col-md-6 ">
               <div class="logo-part">
                  <img src="images/ebk2.jpg" class="w-50 logo-footer" >
         ...
         <div class="row">
            <div class="col-md-6 px-4">
               ...
               <div class="row ">
                  ...
                  <div class="col-md-6 px-4">
                     <ul>
                        <li> <a href="index.jsp"> E-Books</a> </li>
                        <li> <a href="all_newbooks.jsp"> New Books</a> </li>
                        <li> <a href="all_recentbooks.jsp"> Recent Books</a> </li>
                        <li> <a href="all_oldbooks.jsp"> Old Books</a> </li>
                        <li> <a href="#"> Term</a> </li>
